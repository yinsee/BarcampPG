...
function init_db()
{
    db = window.openDatabase("barcamp", "1.0", "Barcamp Database", 1000000);
...
function scannerSuccess(result) {
    ...
    $.getJSON('http://wsatp.com/barcamp.php', { a:'query', t:result.text }, function(r){
              ...
              if (r==null || !r || r==undefined || r.email==undefined) { $('#scanner-output').html('<p align=center><img src="troll.jpg"><br>Bad QR Code, try again.</p>'); return; }
              var html = '';
              contact = r;
              html += '<br>Name: ' + r.name;
